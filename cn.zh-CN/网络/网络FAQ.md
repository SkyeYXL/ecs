...
-   检查ECS实例是否有公网IP
    ...
    -   通过升级公网带宽配置来获取固定公网IP，具体操作请参见[包年包月实例修改带宽](/cn.zh-CN/实例/升降配实例/降配包年包月实例/包年包月实例实时降配带宽.md)或[按量付费实例修改带宽](/cn.zh-CN/实例/升降配实例/升降配按量付费实例/按量付费实例修改带宽.md)。
-   关闭IE浏览器的增强安全配置
...
-   变更实例公网带宽，从而分配一个固定公网IP地址。包年包月实例请参见[升降配方式概述](/cn.zh-CN/实例/升降配实例/升降配方式汇总.md)，按量付费实例请参见[按量付费实例修改带宽](/cn.zh-CN/实例/升降配实例/升降配按量付费实例/按量付费实例修改带宽.md)。
