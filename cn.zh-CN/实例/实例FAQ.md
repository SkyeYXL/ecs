...
节省计划支持三种付款类型：全预付、部分预付和0预付。不同支付方式对应不同折扣力度，更多说明请参见[节省计划](/cn.zh-CN/产品定价/计费方式/节省计划.md)。
...
可以，但需要预先停止实例。您可以参见文档[按量付费实例变配规格](/cn.zh-CN/实例/升降配实例/升降配按量付费实例/按量付费实例变配规格.md)或者通过API接口[ModifyInstanceSpec](/cn.zh-CN/API参考/实例/ModifyInstanceSpec.md)升级按量付费实例的配置。
...
升级ECS资源的方式请参见[升降配方式概述](/cn.zh-CN/实例/升降配实例/升降配方式汇总.md)。
...
不变。按量付费转包年包月功能只支持转换实例和云盘的计费方式，带宽计费方式的变更方法请参见[升降配方式概述](/cn.zh-CN/实例/升降配实例/升降配方式汇总.md)。
