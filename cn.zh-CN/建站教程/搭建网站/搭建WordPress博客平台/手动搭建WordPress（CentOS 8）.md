...
2.  下载并解压WordPress，然后移动至网站根目录。
    ...
    6.  修改完成后，按下Esc键后，输入`:wq`并回车以保存并关闭配置文件。
...
3.  修改Nginx配置文件。
    ...
    2.  按i键进入编辑模式。
        ...
        ![nginx](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/6500430061/p167509.png)

        在`location ~ .php$`大括号内，将`root`后的内容替换为wordpress根目录。

        ![nginx](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/6500430061/p167510.png)
