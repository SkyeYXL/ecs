...
You can call this operation to modify the properties of one or more Elastic Block Storage \(EBS\) devices, including their names, descriptions, and whether they are released along with their attached instances.
...
-   You can call the `DiskIds.N` operation to modify the properties of multiple EBS devices at a time, including their names, descriptions, and whether they are released along with their attached instances.
...
|DiskIds.N|RepeatList|No|d-bp1famypsnar20bv\*\*\*\*|The ID of disk N to be modified. Valid values of N: 0 to 100.
