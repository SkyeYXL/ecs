...
-   FPGA计算型：f1、f3
-   弹性裸金属服务器（神龙）：ebmgn6e、ebmgn6v、ebmgn6i、ebmc6、ebmg6、ebmr6、ebmhfc6、ebmhfg6、ebmhfr6、ebmc5s、ebmg5s、ebmr5s、ebmhfg5、ebmc4、ebmg5
-   超级计算集群（SCC）：scchfc6、scchfg6、scchfr6、sccg5、scch5、sccgn6

## 可变配的实例规格

以下表格中，可变配的目标规格族适用于包年包月实例和按量付费实例。变配方式请参见[升降配方式概述](/intl.zh-CN/实例/升降配实例/升降配方式汇总.md)。
...
-   如需从g6、c6、r6升配至第六代增强型实例（g6e、c6e、r6e），请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)。升配后，不支持降配。
